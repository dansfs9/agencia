				...
				<div class="pad group">
					...
					<div class="grid one-half">
						...
						<div id="copyright">
							...
							<?php else: ?>
								<p><?php bloginfo(); ?> &copy; <?php echo date( 'Y' ); ?>. <?php _e( 'Todos os Direitos Reservados.', 'hueman' ); ?></p>
							<?php endif; ?>
						</div><!--/#copyright-->
						
						<?php if ( ot_get_option( 'credit' ) != 'off' ): ?>
						<div id="credit">
							Conheça Nosso Portal <a href="http://www.cienciaweb.com.br">"Ciência Web"</a> Powered by <a href="http://wordpress.org">WordPress</a><br/>
						</div><!--/#credit-->
						<?php endif; ?>
