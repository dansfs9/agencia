...
<section id="comments" class="themeform">
	...
	<?php if ( have_comments() ) : global $wp_query; ?>
		...
		<h3 class="heading"><?php comments_number( __( 'Nenhuma Resposta', 'hueman' ), __( '1 Resposta', 'hueman' ), __( '% Respostas', 'hueman' ) ); ?></h3>
	
		<ul class="comment-tabs group">
			<li class="active"><a href="#commentlist-container"><i class="fa fa-comments-o"></i><?php echo count($wp_query->comments_by_type['comment']); ?> <?php _e( 'Comentários', 'hueman' ); ?></a></li>
